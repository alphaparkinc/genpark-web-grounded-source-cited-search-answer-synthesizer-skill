# genpark-web-grounded-source-cited-search-answer-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Web-grounded neural search synthesizer with verified citations (Perplexity style)
